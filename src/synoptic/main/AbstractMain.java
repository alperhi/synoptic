...
public abstract class AbstractMain {
	...
	private static TemporalInvariantSet minedInvs;
	...
	public PartitionGraph createInitialPartitionGraph() throws Exception {
		...
		// //////////////////
		minedInvs = mineTOInvariants(options.useTransitiveClosureMining,
				traceGraph);
		// //////////////////
	 ...
	 * @return List<String>
	 */
	public static TemporalInvariantSet getInvariants() {
		return minedInvs;
	}
